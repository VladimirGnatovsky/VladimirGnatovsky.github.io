...
!function(e){var t,s="switcher-inline",i="styleswitcher_title",c="witcher-inline-body",o="styleswitcher_scheme",a="colorScheme",n=function(e){this.options=e};(t=e.cookie("rd-scheme"))?(e("head").append(e("<link/>",{id:a,rel:"stylesheet",href:t})),e("."+o+'[data-url="'+t+'"]').addClass("active")):e("#"+a+"0").addClass("active"),n.prototype={init:function(){this.createDOM(),this.createListeners()},createDOM:function(){e("body").append(e("<div/>",{class:s}).append(e("<h6>",{class:i,text:this.options.title})).append(this.createSchemes()))},createSchemes:function(){var t=e("<div>",{class:c});for(var s in this.options.schemes)t.append(e("<button/>",{id:a+s,class:o,"data-url":this.options.schemes[s].url}).css({background:0==this.options.schemes[s].icon.indexOf("#")?this.options.schemes[s].icon:"url("+this.options.schemes[s].icon+")","background-size":"cover"})).append(" ");return t},createListeners:function(){e("body").delegate("."+o,"click",function(){e("."+o).removeClass("active"),e(this).addClass("active"),e("#"+a).length||e("head").append(e("<link/>",{id:a,rel:"stylesheet"})),e(this).data("url")?(e("#"+a).attr("href",e(this).data("url")),e.cookie("rd-scheme",e(this).data("url"),{expires:365,path:"/"})):(e("#"+a).remove(),e.removeCookie("rd-scheme",{path:"/"}))})}},e.rdstyleswitcher=function(t){t=e.extend({},e.rdstyleswitcher.defaults,t);new n(t).init()},e.rdstyleswitcher.defaults={title:"This customization tool allows you to make color changes in your theme.",schemes:[]}}(jQuery);
